...
function Carrinho() {
  ...
  /* O saldo apenas será calculado se o "saldo" ou o "valorTotalCarrinho" mudem. Isso é feito para evitar renderizações desnecessárias nos componentes. */

  const total = useMemo(() => {
    return saldo - valorTotalCarrinho;
  ...
  return (
    <Container>
      ...
      {carrinho.map((produto) => (
        <Produto key={carrinho} {...produto}></Produto>
      ))}
      <PagamentoContainer>
